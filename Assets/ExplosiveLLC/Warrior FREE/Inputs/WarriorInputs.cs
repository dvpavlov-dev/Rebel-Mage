// GENERATED AUTOMATICALLY FROM 'Assets/ExplosiveLLC/Warrior FREE/Inputs/WarriorInputActions.inputactions'
...
{
    public class @WarriorInputs : IInputActionCollection, IDisposable
    {
