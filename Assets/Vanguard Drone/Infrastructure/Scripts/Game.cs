...
public class Game : MonoBehaviour
{
    ...
    [Inject]
    private void Constructor(RoundProcess roundProcess, Factory factory, SpellWindowController spellWindowController, GameplayUI gameplayUI)
    {
    ...
    void Start()
    {
        _stateMachine = new GameStateMachine(_roundProcess, _factory, _spellWindowController, _gameplayUI);
    }
}
